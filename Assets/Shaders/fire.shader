    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_6870 = (i.uv0+node_2918.g*float2(0.2,0.2));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalLocal = _node_8669_var.rgb;
                float3 normalDirection = normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
                float4 node_9561 = _Time;
                float2 node_6870 = (i.uv0+node_9561.g*float2(0.2,0.2));
                float4 _Noise_var = tex2D(_Noise,TRANSFORM_TEX(node_6870, _Noise));
                float node_7622 = (((1.0 - _DissolveAmount)*1.6+-0.8)+_Noise_var.r);
                clip(node_7622 - 0.5);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                float4 node_8179 = _Time;
                float2 node_6870 = (i.uv0+node_8179.g*float2(0.2,0.2));
                float4 _Noise_var = tex2D(_Noise,TRANSFORM_TEX(node_6870, _Noise));
                float node_7622 = (((1.0 - _DissolveAmount)*1.6+-0.8)+_Noise_var.r);
                clip(node_7622 - 0.5);
